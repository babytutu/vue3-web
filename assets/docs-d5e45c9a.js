import{o as a,c as t,a as p}from"./chunks-f038bb17.js";const k={class:"markdown-body"},i=p(`<h1>权限策略</h1><ul><li>后端接口返回菜单权限</li><li>前端配置页面是否需要按钮权限</li><li>进入页面前调用后端接口返回按钮权限并缓存</li><li>离开页面前清除已缓存的按钮权限</li></ul><h2>路由配置</h2><ul><li>auth 权限key</li></ul><pre class="language-js"><code class="language-js"><span class="token punctuation">{</span>
...
<span class="token keyword">const</span> header<span class="token operator">:</span> <span class="token builtin">any</span><span class="token punctuation">[</span><span class="token punctuation">]</span> <span class="token operator">=</span> <span class="token punctuation">[</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">]</span>
</code></pre>`,20),d=[i],g={__name:"auth",setup(s,{expose:n}){return n({frontmatter:{}}),(e,c)=>(a(),t("div",k,d))}},h={class:"markdown-body"},m=p(`<h1>Echart</h1><h2>安装</h2><pre class="language-bash"><code class="language-bash"><span class="token function">yarn</span> <span class="token function">add</span> echarts
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>formModel</span><span class="token punctuation">&gt;</span></span>
</code></pre>`,29),q=[w],v={__name:"form",setup(s,{expose:n}){return n({frontmatter:{}}),(e,c)=>(a(),t("div",f,q))}},_={class:"markdown-body"},C=p(`<h1>扩展全局属性</h1><p>app.config.globalProperties</p><h2>定义</h2><h3>直接定义</h3><pre class="language-ts"><code class="language-ts">app<span class="token punctuation">.</span>config<span class="token punctuation">.</span>globalProperties<span class="token punctuation">.</span>msg <span class="token operator">=</span> <span class="token string">&#39;hello&#39;</span>
...
</code></pre>`,23),T=[C],x={__name:"globalProperties",setup(s,{expose:n}){return n({frontmatter:{}}),(e,c)=>(a(),t("div",_,T))}},A={class:"markdown-body"},j=p(`<h1>页面结构组件</h1><p>页面 100%高度内 flex 布局，一般展示上中下结构</p><h2>插槽</h2><ul><li>header 头部</li><li>footer 底部</li><li>default 自动撑开中间</li></ul><h2>示例</h2><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Layout</span><span class="token punctuation">&gt;</span></span>
...
<span class="token punctuation">/&gt;</span></span>
</code></pre>`,10),D=[z],$={__name:"page",setup(s,{expose:n}){return n({frontmatter:{}}),(e,c)=>(a(),t("div",S,D))}},M={class:"markdown-body"},L=p(`<h1>路由多页签</h1><p>使用 provide 和 inject 实现方法复用</p><h2>路由配置</h2><ul><li>title 页面名称</li><li>closable 可关闭页签</li><li>keepAlive 开启缓存</li></ul><pre class="language-js"><code class="language-js"><span class="token punctuation">{</span>
  <span class="token literal-property property">meta</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
<span class="token function">defineProps</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><h3>操作列</h3><p>通过设置 options 实现操作列快捷配置</p><pre class="language-js"><code class="language-js"><span class="token punctuation">;</span><span class="token punctuation">[</span>
  <span class="token punctuation">{</span>
...
</code></pre>`,21),R=[E],N={__name:"table",setup(s,{expose:n}){return n({frontmatter:{}}),(e,c)=>(a(),t("div",F,R))}},l=Object.assign({"./auth.md":g,"./echart.md":b,"./form.md":v,"./globalProperties.md":x,"./layout.md":O,"./page.md":$,"./tab.md":B,"./table.md":N}),u=[],r={};Object.keys(l).forEach(s=>{const n=s.replace(/^\.\/(.*)\.\w+$/,"$1");u.push(n),r[n]=l[s]});const G={modules:r,list:u};export{G as m};
